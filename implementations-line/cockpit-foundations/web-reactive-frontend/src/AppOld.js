...
import WelcomeSecured from "./routes/Welcome-secured";
			...
			<BrowserRouter>
				<div className="App">
					<Navbar bg="primary" variant="dark" expand="lg">
						<Container fluid>
							...
							<Nav className="me-auto">
								...
								<Nav.Link href="/secured2">Route Secured Screen</Nav.Link>
							</Nav>
					...
					<Routes>
						...
						<Route path="/secured2" element={<Secured onEvent={handleBusEvent} getAccessToken={readAccessToken} />} />
					</Routes>
