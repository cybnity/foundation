    ...
    public void append(Tenant tenant) throws IllegalArgumentException, ImmutabilityException, UnoperationalStateException {
        if (tenant != null) {
            ...
            if (snapRepo != null) {
                ...
                SnapshotProcessEventStreamPersistenceBased snapshotProcess = new SnapshotProcessEventStreamPersistenceBased(/* streamedEventsProvider*/ this, /* snapshotsPersistenceSystem */ snapRepo, new Tenant.MutedTenantFactory(), /* Expiration time */ null) {
                    @Override
