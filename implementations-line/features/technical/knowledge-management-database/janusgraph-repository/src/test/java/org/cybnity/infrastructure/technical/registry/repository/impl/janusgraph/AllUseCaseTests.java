 ...
 */
@Suite
@SelectClasses({GraphElementsManagementUseCaseTest.class, JanusGraphSchemaCreationUseCaseTest.class, ActivateGraphUseCaseTest.class, DomainTransactionsRepositoryUseCaseTest.class})
