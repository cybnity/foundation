Feature: Create a standardized process
  ...
  Scenario Outline: Company risk manager create a risk process management based on a standard referential as his company's default risk management process 
    ...
    Examples:
    | referential | processName |     description                     |           type          | stepsQty | language |                           phaseNames                                    |
    |    "NIST"   |    "RMF"    | "Risk management framework process" | "cybersecurity process" |    7     |   "en"   |      "PREPARE,CATEGORIZE,SELECT,IMPLEMENT,ASSESS,AUTHORIZE,MONITOR"     |
    |    "NIST"   |    "RMF"    | "Risk management framework process" | "cybersecurity process" |    7     |   "fr"   |  "PRÉPARE,CATÉGORISE,SÉLECTIONNE,IMPLÉMENTE,ÉVALUE,AUTHORISE,SURVEILLE" |