...
## REUZABLE FRAMEWORK DOCKER IMAGES PROJECTS
...
- [jre-tee](../framework/java-tee-container): build project of a Java Runtime Environment image defining a Trusted Execution Environment (TTE) reusable by Java custom applications dockerized module.
