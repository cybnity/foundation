...
See [systems and tools prerequisites documentation](systems-and-tools-prerequisites.md) for detail about the resources requirements relative to the tools and systems used for delivery and/or operating of CYBNITY environments.
