...
|RKE2 cluster|RKE2, SUSE Linux Enterprise Micro (Base OS, Podman, LIBVIRT/KVM, Cockpit, Salt-Minion)|- RAM: 8GB+<br>- CPU: 4+ cores|RKE2 Kubernetes platform.<br>Supported [Linux distributions](https://www.suse.com/suse-rke2/support-matrix/all-supported-versions/rke2-v1-30/).<br>Cockpit Web server for Linux OS remote administration.<br>Podman as virtual containers management Command-LIne tool|
