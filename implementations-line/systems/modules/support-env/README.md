...
|RKE2 cluster|RKE2, SUSE Linux Enterprise Micro of supported [Linux distributions](https://www.suse.com/suse-rke2/support-matrix/all-supported-versions/rke2-v1-30/)|- RAM: 8GB+<br>- CPU: 4+ cores|Kubernetes platform|
