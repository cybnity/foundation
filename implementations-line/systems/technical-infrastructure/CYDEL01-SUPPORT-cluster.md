...
- If it's a certificates update process performed onto an existing Rancher installation:
  ...
  - Reconfigure Rancher agents: see the [Reconfigure Rancher agents documentation](https://github.com/rancher/rancher-docs/blob/main/docs/getting-started/installation-and-upgrade/resources/update-rancher-certificate.md#4-reconfigure-rancher-agents-to-trust-the-private-ca)
    - Force a redeploy of the Rancher agents for each cluster as described into [Rancher documentation](https://github.com/rancher/rancher-docs/blob/main/docs/getting-started/installation-and-upgrade/resources/update-rancher-certificate.md#method-1-force-a-redeploy-of-the-rancher-agents) via command:
    ```
      ...
      # Reployment of DEV-DEPLOY CLUSTER ID agents
      kubectl annotate clusters.management.cattle.io dev-deploy io.cattle.agent.force.deploy=true
    ```
