...
public abstract class ChildFact implements IHistoricalFact, IdentifiableFact {
     ...
     * includes the identity of its parent, it shall follow the Ownership pattern.
    ...
    protected ChildFact(
        ...
        if (id != null && (id.name() == null || id.name().isEmpty() || id.value() == null)) {
        ...
        if (parentDependentId.name() == null || parentDependentId.name().isEmpty()
        ...
        if (identifiers != null && !identifiers.isEmpty()) {
            ...
            try {
                for (Identifier id : identifiers) {
                    ...
                    if (id.name() == null || id.name().isEmpty() || id.value() == null) {
