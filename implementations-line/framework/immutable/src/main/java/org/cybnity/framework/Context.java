...
public class Context implements IContext {
    ...
    public Object get(Class<?> typeOfResult) {
        ...
        if (typeOfResult != null) {
            ...
            for (Entry<String, ResourceItem> item : resources.entrySet()) {
                ...
                if (itemType != null && itemType.getName().equals(typeOfResult.getName())) {
    ...
    public Object get(String resourceName) {
        ...
        if (resourceName != null && !resourceName.isBlank()) {
            // Search resource definition with equals name into the container
            ...
            if (foundRef == null) {
                // Dynamic attempt to find the resource name from the system environment variables
                foundRef = System.getenv(resourceName);
            }
        }
        return foundRef;
    }
    ...
    protected static class ResourceItem {
         ...
         *                        containerized and that should be providable as
         *                        resource.
