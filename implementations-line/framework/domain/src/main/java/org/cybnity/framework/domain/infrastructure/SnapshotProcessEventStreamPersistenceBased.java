...
public abstract class SnapshotProcessEventStreamPersistenceBased extends AbstractSnapshotProcess {
     ...
     */
    public SnapshotProcessEventStreamPersistenceBased(IEventStore streamedEventsProvider, ISnapshotRepository snapshotsPersistenceSystem, MutedAggregateFactory instancePreparer) throws IllegalArgumentException {
        super();
