...
public abstract class CommandHandlingService {
     ...
     */
    private HashMap<String, CommandHandler> delegation;
     ...
     *                                          instances are not valid.
     */
    private void initializeHandlers() throws InvalidTargetObjectTypeException {
	...
	if (!eligibleDelegation.isEmpty()) {
	    this.delegation = eligibleDelegation;
	    return;
	}
    ...
    /**
     * Get the handlers instancesd that are currently managed by this service.
     * 
    ...
    /**
     * Get a set of command handlers that are managed regarding this aggregate type,
     * and supporting the commands to treat.
     * 
