...
/**
 * Factory of command event supported by the AC domain UI api.
 */
public class CommandFactory {
    /**
     * Factory of a type of command supported by the AC domain UI layer API.
     *
     ...
     * @return Instance of concrete event including all the attributes and standard additional elements required by the UI API.
