...
public class ApplicativeRoleAllocationCommandHandler implements ICommandHandler {
    ...
    private final Class<?> supportedCommand = AssignRoleToUserAccountCommand.class;
    private final UserAccountManagementDomainContext context;
    private final Logger logger = Logger.getLogger(ApplicativeRoleAllocationCommandHandler.class.getName());
