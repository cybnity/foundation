...
public class UserAccountStoreImpl implements UserAccountStore {
     ...
     */
    private ConcurrentHashMap<String, LinkedList<UserAccountAggregate>> registries = new ConcurrentHashMap<String, LinkedList<UserAccountAggregate>>();
	...
	try {
	    ...
	    System.out.println("UserAccountStore successfully updated with a new version of UserAccountAggregate (id="
		    + accountUID + ")");
	    // Build event child based on the created account (parent of immutable story)
	    CommonChildFactImpl persistedVersion = new CommonChildFactImpl(account,
