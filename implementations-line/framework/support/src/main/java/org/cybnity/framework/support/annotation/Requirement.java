...
@Documented
@Retention(CLASS)
@Target({ TYPE, METHOD, PARAMETER, LOCAL_VARIABLE, PACKAGE, TYPE_PARAMETER, FIELD })
/**
...
public @interface Requirement {
     ...
     *         equals to REQ_SEC_8310_AC2 identifier regarding a link to a
     *         countermeasure specification identified as Security Requirement
